...
public class RoomController {
    ...
    private ObjectController objectController; // NEW: Reference to the specialized controller
    ...
    // NEW: Setter for the ObjectController
    ...
    // REMOVED: setObjectsPanel, handleAddObjectAction, handleEditObjectAction are gone
    ...
    public void handleLoadRoomAction() {
        ...
        if (selectedFile.isPresent()) {
            ...
            try {
                ...
                // Delegate to the ObjectController
